...
6. Now, click <a href="/tech-academy-japan/environments/" target="_blank">here</a> to open the **Team Environments** page. Or select the **Team Environments** link on the left menu of this page.
...
11. Copy the **Login with this token** command  and paste on a terminal window.

   ![](images/login-cmd.png)

   'Note': You should have received an invitation for the GitHub Organization of your team. Don't forget to accept it in your Github account email.
